...
Viewer Viewer::main(glm::vec3(10, 10, 10), glm::vec3(0, 0, 0), glm::vec3(0, 1, 0), 45.0f, (16 / (float)9));
...
glm::mat4 Viewer::getViewMatrix() const { return glm::lookAt(m_viewPoint, m_viewCenter, m_upVector); }
glm::mat4 Viewer::getProjectionMatrix() const {	return glm::perspective(m_fieldOfView, m_aspectRatio, 0.1f, 500.0f); }
